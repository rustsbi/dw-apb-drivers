...
/// DW_apb_gpio register block.
///
/// This is the maximum register layout; access only the features implemented by the SoC.
///
/// Ref: Synopsys DW_apb_gpio Databook 2.11a (June 2015), table 6-1, sections 6.3, 7.3 and 9.1.
#[doc(alias = "DW_apb_gpio")]
#[repr(C)]
...
#[repr(transparent)]
pub struct PinBits(pub(crate) u32);
...
/// Level-sensitive interrupt synchronization control register.
#[doc(alias = "GPIO_LS_SYNC")]
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
#[repr(transparent)]
